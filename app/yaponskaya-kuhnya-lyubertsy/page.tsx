...
export const metadata: Metadata = {
  title: "Японская кухня в Люберцах с доставкой | Аригато Суши",
  description:
    "Японская кухня с доставкой в Люберцах: суши, роллы, поке, мисо-суп, том ям. Свежие ингредиенты, быстрая доставка от 30 минут. Аригато Суши — Шоссейная 42.",
  keywords:
  ...
  openGraph: {
    title: "Японская кухня в Люберцах | Аригато Суши",
    description:
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert max-w-none mb-10 text-gray-300 leading-relaxed space-y-4">
          <p>
            <strong>Аригато Суши</strong> — ваш ресторан японской кухни в
