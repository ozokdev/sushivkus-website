...
export const metadata: Metadata = {
  title: "Акции на суши в Люберцах — скидки и выгодные предложения | Суши Вкус",
  description:
    "Акции и скидки на доставку суши в Люберцах. Выгодные сеты, бесплатная доставка от 1000 ₽, скидки на первый заказ. Суши Вкус — Шоссейная 42.",
  keywords:
    "акции суши Люберцы, скидки суши Люберцы, выгодные сеты Люберцы, промо суши, акции на роллы",
  alternates: { canonical: "/akcii" },
  openGraph: {
    title: "Акции на суши в Люберцах | Суши Вкус",
    description:
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-300 mb-10 max-w-2xl leading-relaxed">
          Выгодные предложения от <strong>Суши Вкус</strong>. Экономьте на
